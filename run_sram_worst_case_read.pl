...
while(!$done){
    ...
    #print info for user
    if($dreads == 1){
	print USRFILE "Destructive read at ".$vdd."V. (max_bit_b = ".$val_int."V)\n";
	print "Destructive read at ".$vdd."V. (max_bit_b = ".$val_int."V)\n";
    } else {
	print USRFILE "Pass read at ".$vdd."V. (max_bit_b = ".$val_int."V)\n";
	print "Pass read at ".$vdd."V. (max_bit_b = ".$val_int."V)\n";
    }
